...
var generalModule = (function () {
    ...
    my.getODataEndPoint = function () {
        return common.Xrm.get().Page.context.prependOrgName("/api/data/v8.1/");
    }
    my.dateToString = function (date) {
        if (!date)
            return "";
...
var common = (function () {
    ...
    var my = {
        solutionAdaptions: {},
        fetchXml: fetchXmlModule,
        odataSync: odataSyncModule,
        odataAsync: odataAsyncModule,
                ...
                Xrm = {
                    ...
                    Page: {
                        ...
                        context: {
                            ...
                            prependOrgName: function (link) {
                                return "http://hoganascrmdev/HoganasTEST2" + link;
                            }
                        },
